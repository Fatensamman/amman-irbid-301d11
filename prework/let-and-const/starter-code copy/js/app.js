...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT:>>> because the 'const' is a block scoped, and here we used it in a while loop so we can't use it out of this block of code which is "while loop"
  console.log(viewed);
